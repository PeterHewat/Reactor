...
| Resource                                                     | Purpose                                              |
| ------------------------------------------------------------ | ---------------------------------------------------- |
| [docs/getting-started.md](docs/getting-started.md)           | **Start here** — `bun run setup` + commands          |
| [docs/customize-after-fork.md](docs/customize-after-fork.md) | Post-template rename, secrets, and slice removal     |
