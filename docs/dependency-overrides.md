...
Root `package.json` `overrides` pin **transitive** dependency versions for security fixes. Run `bun run audit` after changing them.

| Package           | Override  | Reason                                                                                                   |
| ----------------- | --------- | -------------------------------------------------------------------------------------------------------- |
| `ws`              | `^8.20.1` | ReDoS / security advisories in older 8.x                                                                 |
...
| `yaml`            | `^2.8.3`  | [GHSA-48c2-rrv3-qjmp](https://github.com/advisories/GHSA-48c2-rrv3-qjmp) (stack overflow in nested YAML) |
