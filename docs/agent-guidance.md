...
4. **[docs/adr/](./adr/)** — Accepted architectural decisions (backend choice, package boundaries).
5. **[docs/monorepo-structure.md](./monorepo-structure.md)** — Layout, env layers, aliases, typecheck vs build, growth thresholds.
6. **[docs/setup.md](./setup.md)** — First-time scaffolding and platform setup.
7. **[docs/platforms.md](./platforms.md)** — Apps, shared packages, CI expectations.
